...
class Collater_inf(SimpleCollater):
    def __init__(
        self,
        alphabet: str,
        pad=False,
    ...
    def _prep(self, sequences):
        ...
        t1 = [torch.LongTensor(self.tokenizer.tokenize(s)) for s in tcr1]
        ...
        t1 = one_hot_encode(t1, 29)
        t2 = one_hot_encode(t2, 29)

        return seq, m1, m2, t1, t2

    def __call__(self, batch):
        sequences = batch
        return self._prep(sequences)
